class Game {
  constructor() {
    gameBoxNode.style.backgroundImage = "url('Fotos/Fondos/Stage 7.jpeg')";
  ...
  obstAppear = () => {
    for (let i = 0; i < 9; i++) {
      let stage = new Platform(150, i * 65 + 50, 25, 15); // i * (espaciado entre nubes) + (posicion de la primera nube respectivamente del techo)
